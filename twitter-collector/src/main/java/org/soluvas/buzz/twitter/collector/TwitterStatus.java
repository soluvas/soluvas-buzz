...
/**
 * TwitterStatus is formal name for what we call a 'tweet'.
 * We make this a flat structure to make it portable, easily exportable to/processable in Spark.
...
public class TwitterStatus implements Serializable {
    ...
    private Polygon placeBoundingBox;
    ...
    /**
     * Owner of a project is Buzz account. An account can be shared by multiple users.
     * A project ID namespace is tenant-wide, so it's usually auto-generated from project name to avoid
     * name collision.
     * @return
     */
    ...
    public Polygon getPlaceBoundingBox() {
        return placeBoundingBox;
    }

    public void setPlaceBoundingBox(Polygon placeBoundingBox) {
        this.placeBoundingBox = placeBoundingBox;
    }
